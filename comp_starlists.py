...
def test_yelda(pa1='mag07maylgs_kp_rms.lis', pa2='mag07maylgs_tran4_kp_rms.lis', mag_cut=14.5):
    ...
    sigx = np.sqrt(0.5 * denomx / (np.sum(mc1) -1) - 0.5 * (np.mead(lis1['xerr'][idx1][mc1])**2 + np.meadn(lis2['xerr'][idx2][mc1])**2))
